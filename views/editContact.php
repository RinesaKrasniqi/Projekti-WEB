<?php
  ...
  $currentContact = $contact->edit($contactId);
  ...
  <div class="container-3">
     <div class="card-email-form">
         <form class="contact-form" method ="POST">
            ...
            <input type="text" class="form-field"  placeholder="Enter your name" id="Name-1" name="name_c" value="<?php echo $currentContact['name'];?>">
            <p class="field-name">Email Address:</p>
            <input type="email" class="form-field" placeholder="Enter your email" id="Email-1" name="email_c" value="<?php echo $currentContact['email'];?>">
            <p class="field-name">Phone Number:</p>
            <input type="tel" class="form-field" placeholder="Enter your phone number" id="Phone-Number-1" name="number_c" value="<?php echo $currentContact['phone'];?>">
            <p class="field-name">Preferred Appointment Date:</p>
            <input type="date" class="form-field" placeholder="Choose your date" id="datepicker" name="data_c" value="<?php echo $currentContact['date'];?>">
            
            <p class="field-name">Services:</p>
            <select name="teeth" id="teeth" class="form-field" name="service_c" value="<?php echo $currentContact['service'];?>">
            ...
            <textarea id="Message"  placeholder="Your message" class="textarea" name="message_c" value="<?php echo $currentContact['message'];?>"></textarea>
            <input type="submit" class="submit" id="submit" name="submit" value="Update">
        </form>
     </div>
  </div>
